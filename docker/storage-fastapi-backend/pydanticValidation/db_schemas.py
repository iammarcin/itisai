...
class ActivityData(Base):
    ...
    watch_min_temperature = Column(Float, nullable=True)
    watch_max_temperature = Column(Float, nullable=True)
    weather_temperature_on_start = Column(Float, nullable=True)
    weather_relative_humidity_on_start = Column(Float, nullable=True)
    weather_wind_direction_on_start = Column(String(10), nullable=True)
    weather_wind_speed_on_start = Column(Float, nullable=True)
    weather_wind_gust_on_start = Column(Float, nullable=True)
    weather_type_desc = Column(String(50), nullable=True)
