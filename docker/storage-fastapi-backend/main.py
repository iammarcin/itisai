...
from pydanticValidation.general_schemas import TestModel, MediaModel #, GenerateAssetOrSuggestion, ProcessWebUrl, ProcessYTSubmit
...
async def stream(job_request: TestModel):
