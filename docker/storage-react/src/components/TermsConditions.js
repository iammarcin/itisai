...
const TermsAndConditions = () => {
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: 'auto', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>Welcome to "Good to great life". Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using our chat application (the "Service").</p>
      ...
      <p>We reserve the right to modify or replace these Terms at any time. We will notify you of any changes by posting the new Terms on this page. Your continued use of the Service after such changes constitutes your acceptance of the new Terms.</p>
      ...
      <ul>
        ...
        <li>Post or transmit any material that is harmful, offensive, or otherwise objectionable.</li>
